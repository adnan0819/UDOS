...
## Structure
Appendix/					# this directory contains the Appendix containing all additional experiments referenced in the main paper
Data/				 # the dataset contining the five informal settlements' vector shapefiles
Code/               # the codebase
...
once it appears on AAAI library
```
---